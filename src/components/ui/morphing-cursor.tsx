...
export function MagneticText({
  ...
  return (
    <div
      ...
      className={cn("relative inline-flex items-center justify-center cursor-none select-none py-2 px-4 rounded-2xl", className)}
    >
      {/* Base text layer - original text */}
      <span className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-slate-800 transition-colors">
        {text}
      </span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-gradient-to-r from-rose-500 to-pink-600 shadow-xl overflow-hidden"
        style={{
          width: isHovered ? 170 : 0,
      ...
      >
        ...
        >
          <span className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white whitespace-nowrap">
            {hoverText}
          </span>
        </div>
      </div>
